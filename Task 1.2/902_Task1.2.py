...
def color_detect(img):
    ...
    if(img == 'Image1.jpg'):
        ...
        with open('902_Task1.2.csv','a',newline='') as fp:
             a = csv.writer(fp,delimiter=',')
             data = [['Image Name','Arucoid','object1','object2'],['Image1.jpg',arucoid,str(tuple1),str(tuple2)]]
             a.writerows(data)
            ...
            with open('902_Task1.2.csv','a',newline='') as fp:
                 a = csv.writer(fp,delimiter=',')
                 data = [['Image Name','Arucoid','object1'],['Image2.jpg',arucoid,str(tuple1)]]
                 a.writerows(data)
            ...
            with open('902_Task1.2.csv','a',newline='') as fp:
                 a = csv.writer(fp,delimiter=',')
                 data = [['Image Name','Arucoid','object1','object2'],['Image3.jpg',arucoid,str(tuple1),str(tuple2)]]
                 a.writerows(data)
            ...
            with open('902_Task1.2.csv','a',newline='') as fp:
                 a = csv.writer(fp,delimiter=',')
                 data = [['Image Name','Arucoid','object1'],['Image4.jpg',arucoid,str(tuple1)]]
                 a.writerows(data)
            ...
            with open('902_Task1.2.csv','a',newline='') as fp:
                 a = csv.writer(fp,delimiter=',')
                 data = [['Image Name','Arucoid','object1','object2'],['Image5.jpg',arucoid,str(tuple1),str(tuple2)]]
                 a.writerows(data)
